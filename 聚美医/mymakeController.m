...
//    cell.tiemess.textColor = [UIColor redColor];
    ...
    cell.binglibtn.layer.masksToBounds = YES;
    cell.binglibtn.layer.cornerRadius = 3;
    
    if ([doctor.NowState isEqualToString:@"1"]) {
        cell.shijianimage1.image = [UIImage imageNamed:@"shijianzhou"];
        cell.binglibtn.backgroundColor = [self colorWithRGB:0x00CDBE alpha:1];
        [cell.binglibtn setTitle:@"完成治疗" forState:UIControlStateNormal];
        [cell.binglibtn setBackgroundImage:[UIImage imageNamed:@"mymaker_btn.jpg"] forState:UIControlStateNormal];
    }else if ([doctor.NowState isEqualToString:@"2"]){
        cell.shijianimage1.image = [UIImage imageNamed:@"shijianzhou"];
        cell.shijianimage2.image = [UIImage imageNamed:@"shijianzhou"];
        cell.binglibtn.backgroundColor = [self colorWithRGB:0x00CDBE alpha:1];
        [cell.binglibtn setTitle:@"上传病历" forState:UIControlStateNormal];
        [cell.binglibtn setBackgroundImage:[UIImage imageNamed:@"mymaker_btn.jpg"] forState:UIControlStateNormal];
//        [cell.binglibtn setBackgroundImage:[UIImage imageNamed:@"我的预约20150402_03"] forState:UIControlStateNormal];
        ...
        cell.binglibtn.backgroundColor = [self colorWithRGB:0x00CDBE alpha:1];
        [cell.binglibtn setTitle:@"已上传" forState:UIControlStateNormal];
        cell.binglibtn.userInteractionEnabled = NO;
        [cell.binglibtn setBackgroundImage:[UIImage imageNamed:@"mymaker_btn.jpg"] forState:UIControlStateNormal];
