...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        cell.name.frame = CGRectMake(100, 40,[self NSStringwithsize:17 str:data.truename] , 20);
        ...
        cell.age.frame = CGRectMake(100 + [self NSStringwithsize:17 str:data.truename] + 30, 40, [self NSStringwithsize:14 str:cell.age.text], 20);
